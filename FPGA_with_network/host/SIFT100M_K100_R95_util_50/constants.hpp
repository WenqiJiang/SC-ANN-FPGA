...
#define PE_NUM_CENTER_DIST_COMP 5

#define PE_NUM_CENTER_DIST_COMP_EVEN 4
#define CENTROIDS_PER_PARTITION_EVEN 3277
#define CENTROIDS_PER_PARTITION_LAST_PE 3276
