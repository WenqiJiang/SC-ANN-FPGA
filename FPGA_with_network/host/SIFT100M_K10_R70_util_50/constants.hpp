...
#define PE_NUM_CENTER_DIST_COMP 10

#define PE_NUM_CENTER_DIST_COMP_EVEN 9
#define CENTROIDS_PER_PARTITION_EVEN 410
#define CENTROIDS_PER_PARTITION_LAST_PE 406
...
#define PE_NUM_TABLE_CONSTRUCTION 5

#define PE_NUM_TABLE_CONSTRUCTION_LARGER 4
