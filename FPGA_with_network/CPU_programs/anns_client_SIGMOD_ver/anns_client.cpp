...
{ 
    ...
    printf("Usage: executable nlist nprobe IP port thread_num , e.g., ./anns_client 8192 17 1 127.0.0.1 8888 4\n");
    ...
    std::string dir;
    if (OPQ) {
        dir = "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_OPQ16,IVF";
    }
    else {
        dir = "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF";
    }

    std::string query_vector_fname = 
        dir + std::to_string(nlist) + 
        ",PQ16_16_banks/query_vectors_float32_10000_128_raw";
