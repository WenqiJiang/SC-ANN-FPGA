...
elif config["DEVICE"] == "U55C":
    template_fill_dict["DEVICE_NAME"] = "xilinx_u55c_gen3x16_xdma_3_202210_1"
...
# U280 / U50 has HBM
if config["DEVICE"] == "U280" or config["DEVICE"] == "U50" or config["DEVICE"] == "U55C":
