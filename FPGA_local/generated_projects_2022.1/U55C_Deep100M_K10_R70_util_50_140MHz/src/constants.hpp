...
#define PE_NUM_CENTER_DIST_COMP 9

#define PE_NUM_CENTER_DIST_COMP_EVEN 8
#define CENTROIDS_PER_PARTITION_EVEN 456
#define CENTROIDS_PER_PARTITION_LAST_PE 448
