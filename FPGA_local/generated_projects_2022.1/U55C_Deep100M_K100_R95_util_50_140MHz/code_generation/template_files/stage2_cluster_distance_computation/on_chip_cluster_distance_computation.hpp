...
template<const int centroids_per_partition>
...
template<const int centroids_per_partition_last_PE>
...
#pragma HLS stream variable=s_partial_dist depth=16
    ...
    compute_cell_distance_head_component_A<centroids_per_partition>(
        query_num, 
        systolic_array_id,
        total_centriods, 
...
#pragma HLS stream variable=s_partial_dist depth=16
    ...
    compute_cell_distance_middle_component_A<centroids_per_partition>(
        query_num, 
        systolic_array_id,
        total_centriods, 
        s_centroid_vectors_in,
...
#pragma HLS stream variable=s_partial_dist depth=16
    ...
    compute_cell_distance_tail_component_A<centroids_per_partition_last_PE>(
        query_num, 
        systolic_array_id,
        centroids_per_partition, 
        total_centriods,
...
#pragma HLS stream variable=s_partial_cell_distance_forward depth=16
    ...
    // head
    compute_cell_distance_head_PE<CENTROIDS_PER_PARTITION_EVEN>(
        query_num, 
        0,
        total_centriods,
        s_centroid_vectors,
...
#pragma HLS UNROLL
        compute_cell_distance_middle_PE<CENTROIDS_PER_PARTITION_EVEN>(
            query_num, 
            s,
            total_centriods,
